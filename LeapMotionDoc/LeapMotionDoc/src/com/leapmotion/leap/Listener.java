...
public class Listener {
	...
	public void onServiceConnect(Controller paramController) {
		if (getClass() == Listener.class) LeapJNI.Listener_onServiceConnect(this.swigCPtr, this, Controller.getCPtr(paramController), paramController); else LeapJNI.Listener_onServiceConnectSwigExplicitListener(this.swigCPtr, this, Controller.getCPtr(paramController), paramController);
	}

	public void onServiceDisconnect(Controller paramController) {
		if (getClass() == Listener.class) LeapJNI.Listener_onServiceDisconnect(this.swigCPtr, this, Controller.getCPtr(paramController), paramController); else LeapJNI.Listener_onServiceDisconnectSwigExplicitListener(this.swigCPtr, this, Controller.getCPtr(paramController), paramController);
	}

	public void onDeviceChange(Controller paramController) {
		if (getClass() == Listener.class) LeapJNI.Listener_onDeviceChange(this.swigCPtr, this, Controller.getCPtr(paramController), paramController); else LeapJNI.Listener_onDeviceChangeSwigExplicitListener(this.swigCPtr, this, Controller.getCPtr(paramController), paramController);
	}

	public void onImages(Controller paramController) {
		if (getClass() == Listener.class) LeapJNI.Listener_onImages(this.swigCPtr, this, Controller.getCPtr(paramController), paramController); else LeapJNI.Listener_onImagesSwigExplicitListener(this.swigCPtr, this, Controller.getCPtr(paramController), paramController);
	}
}
